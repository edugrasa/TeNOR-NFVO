...
TeNOR is the NFV Orchestrator platform developed by the [T-NOVA](http://www.t-nova.eu) project, is used as bases for SESAME NFV to handle entire NFV lifecycle management. 
